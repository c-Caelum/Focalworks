...
loom {
    forge {
        ...
        mixinConfig(
            "focalworks-common.mixins.json",
            "focalworks-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("focalworks.apply-datagen-mixin", "true")
                property("focalworks.$platform-datagen", "true")
            }
        }
    }
}

focalworksModDependencies {
