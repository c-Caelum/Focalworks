...
abstract class FocalworksModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<FocalworksModDependenciesExtension>("focalworksModDependencies")
